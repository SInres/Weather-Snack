                      ...
                      <div class="weather-card one">
                          <div class="top">
                              <div class="wrapper">
                                  ...
                                  <h3 class="location">{{$current_weather->name . ', ' . $current_weather->sys->country}}</h3>
                                  <p class="temp">
                                      <span class="temp-value">{{number_format($current_weather->main->temp, 0)}}</span>
                                      <span class="deg">0</span>
                                      <a href=""><span class="temp-type">C</span></a>
                                  </p>
                                  <h1 class="heading">
                                      {{$current_weather->weather[0]->main}}
                                      <img src="http://openweathermap.org/img/w/{{$current_weather->weather[0]->icon}}.png" alt="">
                                  </h1>
                              </div>
                          </div>
                          <div class="bottom">
